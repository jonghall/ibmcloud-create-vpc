...
def main(region, topology):
    # Get Zones for specified region
    zones = getzones(region)
...
def createinstance(zone_name, instance_name, vpcid, image_id, profile_name, sshkey_id, subnet_id, security_group,
                   user_data):
    ##############################################
